  ...
  const base: AnswerFile = {
    ...
    investigation_record: [
      ...
      },
      {
        ...
        type: "tool_call",
        state: "INVESTIGATING",
        payload: { tool: "get_transaction_history", args: { entity_id: "C04570-K1" } },
      },
      {
        seq: 2,
        ts: "2016-11-12T00:47:40Z",
        case_id: "HHG-017",
        type: "evidence_added",
        state: "ASSESSING",
        payload: { claim: "Three online authorizations under $3 within 40 minutes" },
      },
      {
        seq: 3,
        ts: "2016-11-12T00:48:00Z",
        case_id: "HHG-017",
        type: "done",
        state: "DONE",
        payload: { stop_reason: "Customer denial settled the verdict" },
      },
    ],
