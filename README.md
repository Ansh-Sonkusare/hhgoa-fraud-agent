...
| 3–5 minute demo video, end to end | published separately (link to be added) | Not recorded yet |
| Technical blog post (what, architecture, TigerGraph use, agentic capabilities, learnings, improvements) | published separately (link to be added) | Written; not published yet |
